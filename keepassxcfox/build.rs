...
fn main() {
    ...
    let export_file_path = env::var("EXPORTS_FILE").expect("No EXPORTS_FILE ?");
    ...
    if cfg!(target_env = "msvc") {
        ...
        data_file
            .write("EXPORTS\n".as_bytes())
            .expect("failed writing .def headers");
    ...
    println!(
        "cargo:rustc-env=OUTPUT_PATH={}",
        env::var("OUTPUT_PATH").expect("No OUTPUT_PATH ?")
    );
}
